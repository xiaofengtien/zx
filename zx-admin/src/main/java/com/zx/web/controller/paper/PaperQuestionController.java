...
import com.zx.student.archive.domain.bo.paper.PaperQuestionListBO;
import com.zx.student.archive.domain.bo.paper.PaperQuestionAddBO;
import com.zx.student.archive.domain.bo.paper.PaperQuestionRemoveBO;
import com.zx.student.archive.domain.bo.paper.PaperQuestionBatchSaveBO;
        ...
        List<PaperQuestionDTO> dtoList = paperQuestions.stream()
            .map(pq -> {
                ...
                if (pq.getQuestionId() != null) {
                    try {
                        com.zx.student.archive.domain.bo.question.QuestionIdBO questionIdBO = 
                            new com.zx.student.archive.domain.bo.question.QuestionIdBO();
