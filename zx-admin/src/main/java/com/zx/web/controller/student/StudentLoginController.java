...
import com.zx.student.archive.domain.bo.paper.PaperIdsBO;
...
public class StudentLoginController extends BaseController {
    ...
    @Autowired
    private com.zx.student.archive.service.paper.impl.PaperPackageService paperPackageService;

    @Autowired
    private OssUtil ossUtil;

    @Autowired
    private com.zx.student.archive.service.paper.IAppUserPaperService appUserPaperService;
    ...
    public AjaxResult getInfo() {
        ...
        // 获取学员档案信息（包含适用考卷类型）
        com.zx.student.archive.domain.StudentArchive archive = null;
    ...
    public TableDataInfo syncPaperList(@RequestBody com.zx.student.archive.domain.bo.paper.PaperPageBO pageBO) {
        try {
            // 验证学员身份
            com.zx.common.core.domain.model.LoginUser loginUser = SecurityUtils.getLoginUser();

            if (pageBO == null) {
                pageBO = new com.zx.student.archive.domain.bo.paper.PaperPageBO();
            }
    ...
    public AjaxResult syncPaperDetail(@RequestBody com.zx.student.archive.domain.bo.paper.PaperIdBO idBO) {
        try {
            // 验证学员身份
            SecurityUtils.getLoginUser();
    ...
    public AjaxResult syncPaperListByIds(
            @Validated @RequestBody com.zx.student.archive.domain.bo.paper.PaperIdsBO idsBO) {
        try {
            // 验证学员身份
            com.zx.common.core.domain.model.LoginUser loginUser = SecurityUtils.getLoginUser();
    ...
    public void syncDownloadPaperPackage(
        ...
        try {
            ...
            // 检查是否已生成试卷包
            if (com.zx.common.utils.StringUtils.isEmpty(paper.getPackageHash()) || paper.getPackageSize() == null) {
    ...
    public AjaxResult submitPaper(
            @Validated @RequestBody com.zx.student.archive.domain.bo.paper.SubmitPaperBO submitBO) {
        try {
            // 验证学员身份
            com.zx.common.core.domain.model.LoginUser loginUser = SecurityUtils.getLoginUser();
            ...
            // 调用服务层保存答题结果
            com.zx.student.archive.domain.dto.paper.UserPaperDTO result = appUserPaperService.submitPaper(submitBO);

            log.info("答题结果保存成功，paperInfoId: {}", result != null ? result.getId() : "null");

            return AjaxResult.success("答题结果提交成功", result);
        } catch (com.zx.common.exception.ServiceException e) {
