...
public class PaperController extends BaseController {
    ...
    @Autowired
    private com.zx.common.utils.oss.exam.question.OssUtil ossUtil;

    @Autowired
    private com.zx.student.archive.service.paper.IChunkUploadService chunkUploadService;
    ...
    public AjaxResult initChunkUpload(
            @Validated @RequestBody com.zx.student.archive.domain.bo.paper.ChunkUploadInitBO initBO) {
        try {
    ...
    public AjaxResult completeChunkUpload(
            @Validated @RequestBody com.zx.student.archive.domain.bo.paper.ChunkUploadCompleteBO completeBO) {
        try {
