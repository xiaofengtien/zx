...
import com.ruoyi.student.archive.service.IStudentOfflineCredentialService;
...
public class StudentLoginServiceImpl implements IStudentLoginService
{
    ...
    public String offlineLogin(String studentAccount, String password, String offlineCredential)
    {
        ...
        {
            com.ruoyi.student.archive.domain.dto.OfflineCredential credential = 
    ...
    {
        com.ruoyi.common.core.domain.entity.SysUser user = null;
        ...
        if (user == null)
        {
            user = new com.ruoyi.common.core.domain.entity.SysUser();
     ...
     */
    @Override
    public com.ruoyi.student.archive.domain.StudentArchive getStudentArchiveById(Long archiveId)
    {
        if (archiveId == null)
        {
            return null;
     ...
     */
    @Override
    public com.ruoyi.student.archive.domain.StudentArchive getStudentArchiveByAccount(String studentAccount)
    {
        if (com.ruoyi.common.utils.StringUtils.isEmpty(studentAccount))
        {
            return null;
        }
