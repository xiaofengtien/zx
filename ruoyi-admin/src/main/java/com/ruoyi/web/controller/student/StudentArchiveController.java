...
import com.ruoyi.student.archive.domain.dto.ArchiveIdDTO;
import com.ruoyi.student.archive.domain.dto.ArchiveBatchIdsDTO;
import com.ruoyi.student.archive.domain.dto.ResetPasswordDTO;
import com.ruoyi.student.archive.domain.dto.ChangePasswordDTO;
import com.ruoyi.student.archive.domain.dto.ForgotPasswordDTO;
...
public class StudentArchiveController extends BaseController
{
    ...
    public AjaxResult changePwd(@RequestBody ChangePasswordDTO dto)
    {
        ...
        {
            // 学员只能修改自己的密码
            com.ruoyi.student.archive.domain.StudentArchive archive = studentArchiveService.selectStudentArchiveById(dto.getArchiveId());
            if (archive == null)
            {
