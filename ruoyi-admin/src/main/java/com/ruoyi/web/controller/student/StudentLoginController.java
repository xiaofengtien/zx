...
public class StudentLoginController extends BaseController
{
    ...
    public AjaxResult getInfo()
    {
        ...
        {
            System.out.println("未找到学员档案，userType: " + user.getUserType() + ", userId: " + user.getUserId() + ", userName: " + user.getUserName());
    ...
    public AjaxResult syncPaperListByIds(@Validated @RequestBody com.ruoyi.student.archive.domain.bo.paper.PaperIdsBO idsBO)
    {
        try
        {
            // 验证学员身份
