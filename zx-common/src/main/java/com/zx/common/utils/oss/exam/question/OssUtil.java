package com.zx.common.utils.oss.exam.question;
...
public class OssUtil {
    ...
    public String getUploadUrl() {
        ...
        // 如果是七牛云，返回区域对应的上传地址
        if (ossService instanceof com.zx.common.utils.oss.impl.QiniuOssService) {
            return ((com.zx.common.utils.oss.impl.QiniuOssService) ossService).getUploadUrl();
        }
        // 阿里云的上传地址在 token 中返回
        return null;
    }
    ...
    public String getPrivateDownloadUrlForBucket(String bucketName, String objectKey, long expiration) {
        IOssService ossService = getOssService();
        if (ossService instanceof com.zx.common.utils.oss.impl.AliyunOssService) {
            return ((com.zx.common.utils.oss.impl.AliyunOssService) ossService)
