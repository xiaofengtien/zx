...
module.exports = {
  ...
  // 例如 https://www.zx.vip/。如果应用被部署在一个子路径上，你就需要用这个选项指定这个子路径。例如，如果你的应用被部署在 https://www.zx.vip/admin/，则设置 baseUrl 为 /admin/。
  ...
  configureWebpack: {
    ...
    plugins: [
      // http://doc.zx.vip/zx-vue/other/faq.html#使用gzip解压缩静态文件
