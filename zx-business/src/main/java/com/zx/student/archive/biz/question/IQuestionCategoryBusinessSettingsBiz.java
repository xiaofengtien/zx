 ...
 * @since 2025-08-16
 */
public interface IQuestionCategoryBusinessSettingsBiz extends IService<QuestionCategoryBusinessSettings> {
     ...
     * @return
     */
    Map<Integer, QuestionCategoryBusinessSettingsDTO> fetchQuestionCategorySettings(List<Integer> businessIds,Integer businessType);
}
