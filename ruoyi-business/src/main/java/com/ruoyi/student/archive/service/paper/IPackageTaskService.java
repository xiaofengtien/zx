...
public interface IPackageTaskService {
     ...
     * @param paperId 试卷ID
     * @return 任务信息
     * @throws com.ruoyi.common.exception.ServiceException 如果任务已存在
     */
    PackageTaskInfo createTask(Integer paperId) throws com.ruoyi.common.exception.ServiceException;
