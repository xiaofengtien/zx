...
public class StudentArchiveServiceImpl implements IStudentArchiveService
{
    ...
    public int resetPassword(Long archiveId, String newPassword)
    {
        ...
        if (archive == null)
        {
            throw new com.ruoyi.common.exception.ServiceException("学员档案不存在");
        }
        ...
        // 更新密码修改时间
        archive.setPwdUpdateDate(com.ruoyi.common.utils.DateUtils.getNowDate());
    ...
    public int changePassword(Long archiveId, String oldPassword, String newPassword)
    {
        ...
        {
            throw new com.ruoyi.common.exception.ServiceException("旧密码和新密码不能为空");
        }
        ...
        {
            throw new com.ruoyi.common.exception.ServiceException("旧密码错误");
        }
        
        // 检查新密码是否与旧密码相同
        if (SecurityUtils.matchesPassword(newPassword, archive.getPassword()))
        {
            throw new com.ruoyi.common.exception.ServiceException("新密码不能与旧密码相同");
        }
    ...
    public int forgotPassword(String studentAccount, String phoneNumber, String newPassword)
    {
        ...
        {
            throw new com.ruoyi.common.exception.ServiceException("学员账号不能为空");
        }
        if (StringUtils.isEmpty(phoneNumber))
        {
            throw new com.ruoyi.common.exception.ServiceException("手机号码不能为空");
        }
        if (StringUtils.isEmpty(newPassword))
        {
            throw new com.ruoyi.common.exception.ServiceException("新密码不能为空");
        }
        if (newPassword.length() < 6 || newPassword.length() > 20)
        {
            throw new com.ruoyi.common.exception.ServiceException("密码长度必须介于 6 和 20 之间");
        }
        ...
        if (archive == null)
        {
            throw new com.ruoyi.common.exception.ServiceException("学员账号不存在");
        }

        // 验证手机号是否匹配
        if (!phoneNumber.equals(archive.getPhoneNumber()))
        {
            throw new com.ruoyi.common.exception.ServiceException("手机号码与账号不匹配");
        }
