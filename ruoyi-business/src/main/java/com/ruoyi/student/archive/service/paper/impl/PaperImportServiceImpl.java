...
import com.ruoyi.student.archive.domain.dto.paper.*;
import com.ruoyi.student.archive.domain.paper.PaperImportSession;
import com.ruoyi.student.archive.domain.question.Question;
import com.ruoyi.student.archive.domain.question.QuestionAnswer;
import com.ruoyi.student.archive.mapper.paper.PaperImportSessionMapper;
...
public class PaperImportServiceImpl implements IPaperImportService {
    ...
    private final com.ruoyi.student.archive.biz.question.IQuestionMediaBiz questionMediaBiz;
    private final com.ruoyi.student.archive.biz.question.IQuestionGroupBiz questionGroupBiz;
                            ...
                            if (section.getQuestionGroups() != null) {
                                for (ParseResultDTO.ParsedQuestionGroupDTO group : section.getQuestionGroups()) {
                                    if (group.getQuestions() != null) {
                                        ...
                                        // 创建题目组记录
                                        com.ruoyi.student.archive.domain.question.QuestionGroup questionGroup = new com.ruoyi.student.archive.domain.question.QuestionGroup();
